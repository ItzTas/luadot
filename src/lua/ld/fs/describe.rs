...
const NAMESPACE_TYPENAME: &str = "ld.fs";

const DOC: &str = "The filesystem, with no directory of a template in the way: `~` and a relative path resolve against your home directory, an absolute one reaches anywhere. Nothing here takes a backup.";
