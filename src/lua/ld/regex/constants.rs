...
pub const GMATCH: &str = "gmatch";

pub const GSUB: &str = "gsub";

pub const SPLIT: &str = "split";

pub const ESCAPE: &str = "escape";

pub const TEXT: &str = "the text";

pub const PATTERN: &str = "the pattern";

#[cfg(feature = "meta")]
pub const NAMESPACE_TYPENAME: &str = "ld.regex";

#[cfg(feature = "meta")]
pub const DOC: &str = "Regular expressions in Rust's syntax, the engine the `regex` rule key uses: linear time, no backreferences or lookaround. Lua strings eat one backslash, so `\\d` is written `\"\\\\d\"`.";
